...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "NEBO-HACKBOT Installer v%s\n\n", version.GetBinaryVersion())
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# NEBO-HACKBOT Environment Configuration
# Generated by NEBO-HACKBOT Installer v%s
#
# This file contains environment variables for NEBO-HACKBOT configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("NEBO-HACKBOT Installer v%s\n", version.GetBinaryVersion())
