...
NEBO-HACKBOT is **MIT licensed** and all dependencies use MIT-compatible licenses.
...
- Backend reports in `/opt/nebo-hackbot/licenses/backend/`
  - `dependencies.txt` - List of all Go modules
  - `licenses.csv` - Detailed license information (generated by go-licenses)
- Frontend reports in `/opt/nebo-hackbot/licenses/frontend/`
