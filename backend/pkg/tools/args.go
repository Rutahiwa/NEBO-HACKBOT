...
type TerminalAction struct {
	...
	Timeout Int64  `json:"timeout,omitempty" jsonschema:"type=integer" jsonschema_description:"Optional execution time limit in seconds. Default is 120 seconds if not provided. Max is 10800 (3 hours). For interactive/long-running commands, use detach=true instead"`
